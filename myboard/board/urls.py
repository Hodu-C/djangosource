...
from .views import base_views, answer_views, question_views, comment_views, voter_views
...
urlpatterns = [
    ...
    path(
        ...
        voter_views.vote_question,
        name="vote_question",
    ),
    path(
        "vote/answer/<int:answer_id>/",
        voter_views.vote_answer,
        name="vote_answer",
    ),
]
